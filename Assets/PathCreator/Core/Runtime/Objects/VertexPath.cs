...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public VertexPath (BezierPath bezierPath, Transform transform, float maxAngleError = 0.0f, float minVertexDst = 0.0f):
        ...
        public void SetNormal (int index, float f)
        {
            localNormals[index].x = f;
        }
